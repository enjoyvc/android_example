...
public class PeerConnectionClient {
  ...
  @Nullable
  static private PeerConnectionFactory factory;
  @Nullable
  ...
  public static class PeerConnectionParameters {
    ...
    public PeerConnectionParameters(boolean videoCallEnabled, boolean loopback, boolean tracing,
        ...
        boolean useLegacyAudioDevice, DataChannelParameters dataChannelParameters, boolean publisher) {
  ...
  private void createMediaConstraintsInternal() {
    ...
    sdpMediaConstraints.mandatory.add(new MediaConstraints.KeyValuePair(
            "OfferToReceiveVideo", String.valueOf(!peerConnectionParameters.publisher)));
  ...
  private void createPeerConnectionInternal() {
    ...
    rtcConfig.continualGatheringPolicy = PeerConnection.ContinualGatheringPolicy.GATHER_ONCE;//PeerConnection.ContinualGatheringPolicy.GATHER_CONTINUALLY;
    ...
    */
    ...
    if(peerConnectionParameters.publisher) {
